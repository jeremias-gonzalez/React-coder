    ...
    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      ...
      <div>
        <div className="mt-20">
          ...
          <div aria-hidden="true" className="pointer-events-none lg:absolute lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl">
            <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
              <div className="flex items-center space-x-6 lg:space-x-6">
                ...
                <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                  <div className="h-10 w-44 overflow-hidden rounded-lg">
          ...
          <a href="#" className="inline-block rounded-md border border-transparent bg-red-600 px-8 py-3 text-center font-medium text-white hover:bg-black">Shop Collection</a>
        </div>
      </div>
    </div>
  </div>
